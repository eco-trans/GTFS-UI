...
window.STOP_DELAY_AVG_URL = `${BASE_META_URL}/stop_delay_avg.json`;
window.STOP_OTP_URL = `${BASE_META_URL}/stop_otp.json`;
window.STOP_ROUTE_OTP_URL = `${BASE_META_URL}/stop_route_otp.json`;
window.SPATIAL_OTP_URL = `${BASE_META_URL}/spatial_otp.json`;
